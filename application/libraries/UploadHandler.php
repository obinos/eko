...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null)
    {
        $this->options = array(
            ...
            'script_url' => $this->get_full_url() . '/purchase/upload' . $this->basename(''),
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/assets/uploads/invoice/',
            'upload_url' => $this->get_full_url() . '/assets/uploads/invoice/',

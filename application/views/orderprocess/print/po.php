                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm content-print" width="100%">
                                <thead>
                                    <tr>
                                        <th colspan="5">
                                            <p>Tgl Kirim: <?= dateindo((strtotime($filter_date) * 1000), 'd-m-Y') ?></p>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="text-center">Catatan Produk</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><?= $data['qty2'] ? $data['qty2'] : $data['qty'] ?></td>
                                            <td><?= nl2br($data['note']) ?></td>
                                            <td><?= $data['penerima_qty'] ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>

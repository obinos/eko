            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form method="post" id="add_message">
                        <input type="hidden" id="app" name="app" value="whatsapp">
        ...
        $("#add_message").validate({
            rules: {
                code: {
                    required: true,
                    remote: {
                        url: "<?= base_url('message/check_message/whatsapp'); ?>",
                        type: "post",
                        data: {
                            id: function() {
                                return null;
                        ...
                        if (result.status == 'success') {
                            $.toast({
                                ...
                                afterHidden: function() {
                                    window.location = "<?= base_url('message/whatsapp') ?>";
                                }
                            });
                        } else {
                            $.toast({

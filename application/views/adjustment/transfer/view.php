                            ...
                            <table class="table table-striped table-sm display table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%" class="text-right">Good</th>
                                        <th style="width: 15%" class="text-right">Damage</th>
                                        <th style="width: 15%" class="text-right">Reject</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $i->barcode ?></td>
                                            <td><?= $i->name ?></td>
                                            <td class="text-right"><?= $i->good ?></td>
                                            <td class="text-right"><?= $i->damage ?></td>
                                            <td class="text-right"><?= $i->reject ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>

...
<script>
    $(document).ready(function() {
        $('#datatable').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('adjustment/get_adjustment/TC'); ?>",
                "type": "POST"
            },
            "columns": [{
                "data": null,
                ...
                "data": "no",
                render: function(data, type, row, meta) {
                    return `<a href='<?= base_url('adjustment/view_transfer/') ?>` + row['_id'] + `'>` + data + `</a>`;
                }
            }, {
                "class": "text-right",
                "data": "items"

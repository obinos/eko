        ...
        <div class="col-lg-12 pad0">
            <div class="ibox ">
                <div class="ibox-title d-flex align-items-center justify-content-between">
                    <h5>Transfer Warehouse</h5>
                    <div class='btn-group btn-group-sm'>
                        <a class='btn btn-warning btn-sm' href='<?= base_url('adjustment/re_transfer_warehouse/' . $adjustment[0]['_id']->id); ?>'>
                            ...
                            <table class="table table-striped table-sm display table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%" class="text-right">Awal</th>
                                        <th style="width: 15%" class="text-right">Transfer</th>
                                        <th style="width: 15%" class="text-right">Akhir</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $i->barcode ?></td>
                                            <td><?= $i->name ?></td>
                                            <td class="text-right"><?= $i->awal ?></td>
                                            <td class="text-right"><?= $i->transfer ?></td>
                                            <td class="text-right"><?= $i->akhir ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>

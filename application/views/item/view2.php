                            ...
                            <table class="table table-striped table-bordered table-sm display" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-middle text-center" rowspan="2">Active</th>
                                        <th class="align-middle text-center" rowspan="2">Kirim Sore</th>
                                        <th class="align-middle text-center" rowspan="2">Nama</th>
                                        <th class="align-middle text-center" rowspan="2">Supplier</th>
                                        <th class="align-middle text-center" rowspan="2">Harga</th>
                                        <th class="align-middle text-center" rowspan="2">Order Limit</th>
                                        <th class="text-center" colspan="5">Stock</th>
                                        <th class="align-middle text-center" rowspan="2">Margin</th>
                                        <th class="align-middle text-center" rowspan="2">Avg HPP</th>
                                        <th class="align-middle text-center" rowspan="2">Last HPP</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="<?= $data['_id'] ?>">
                                            ...
                                            <td class="item_is_preorder"><?= check_boolean($data['is_preorder'], 'is_bestseller') ?></td>
                                            ...
                                            <td class="item_order_limit"><?= $data['order_limit'] ?></td>
                                            <td class="item_stock_managed"><?= check_boolean($data['stock_managed']) ?></td>
                                            <td class="item_stock"><?= $data['stock'] ?></td>
                                            <td class="item_stock_default"><?= $data['stock_default'] ?></td>
                                            <td class="item_stock_min"><?= $data['stock_min'] ?></td>
                                            <td class="item_stock_max"><?= $data['stock_max'] ?></td>
                                            <td class="item_current_profit text-right"><?= $data['current_profit'] ?>%</td>
                                            <td class="item_hpp text-right"><?= $data['purchase_price']->avg_price ? thousand($data['purchase_price']->avg_price) : null ?></td>
                                            <td class="item_lastprice text-right"><?= $data['purchase_price']->last->price ? thousand($data['purchase_price']->last->price) : null ?></td>
                    ...
                    success: function(response) {
                        ...
                        if (result.status == 'success') {
                            ...
                            if (result.is_preorder) {
                                $('tr.' + result._id + ' td.item_is_preorder').html(`<svg width="22" height="22" fill="#8ab661" viewBox="0 0 16 16">
                                    <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/>
                                </svg>`);
                            } else {
                                $('tr.' + result._id + ' td.item_is_preorder').html(``);
                            }
                            ...
                            $('tr.' + result._id + ' td.item_stock_default').text(result.stock_default);
                            $('tr.' + result._id + ' td.item_stock_min').text(result.stock_min);
                            $('tr.' + result._id + ' td.item_stock_max').text(result.stock_max);
                            $('tr.' + result._id + ' td.item_order_limit').text(result.order_limit);
                            $('tr.' + result._id + ' td.item_current_profit').text(result.current_profit + '%');
                            $('tr.' + result._id + ' td.item_hpp').html(separator(result.purchase_price.avg_price));
                            $('tr.' + result._id + ' td.item_lastprice').html(separator(result.purchase_price.last.price));
                            if (result.stock_managed) {
                                $('tr.' + result._id + ' td.item_stock_managed').html(`<svg width="22" height="22" fill="#8ab661" viewBox="0 0 16 16">
                                    <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/>
                                </svg>`);
                            } else {
                                $('tr.' + result._id + ' td.item_stock_managed').html(`<svg width="22" height="22" fill="#fd8664" viewBox="0 0 16 16">
                                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                                </svg>`);
                            }

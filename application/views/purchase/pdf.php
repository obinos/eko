...
$heading = '<h1 align="center">Purchase</h1><br>';
...
$pdf->write1DBarcode($purchase[0]['no'], 'C39', '', '', '', 18, 0.4, $style, 'N');
$html1 = '
<table>
    <tbody>
        <tr>
        ...
        <tr>
            <td>
                Supplier : <strong>' . $purchase[0]['supplier'] . '</strong>
            </td>
            <td align="right">
...
<table>
    <tbody>
        <tr>
            <td>
                Note : <strong>' . $purchase[0]['notes'] . '</strong>
            </td>
        </tr>
    </tbody>
</table>
...
foreach ($item as $itm) {
    $html2 = $html2 . '
        <tr>
            ...
            <td style="width: 45%">' . $itm['name'] . '</td>
            <td style="width: 10%" align="right">' . thousand($itm['qty_unit']) . '</td>
            <td style="width: 8%">' . $itm['unit'] . '</td>
            <td style="width: 9%" align="right">' . thousand($itm['qty']) . '</td>
            <td style="width: 10%" align="right">' . thousand($itm['price']) . '</td>
            <td style="width: 13%" align="right">' . thousand($itm['total_price']) . '</td>
        </tr>';
}
$html3 = '
    </tbody>
    <tfoot>
        <tr>
            ...
            <th align="right"><strong>' . thousand($purchase[0]['total']) . '</strong></th>
        </tr>
    </tfoot>
</table>';
$html = $html1 . $html2 . $html3;
$pdf->writeHTML($html);
$pdf->Output($purchase[0]['no'] . '_' . time() . '.pdf', 'I');

                ...
                <div class="ibox-content">
                    <form method="post" id="form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control date" name="inputdate" value="<?= date('Y-m-d'); ?>" autocomplete="off" placeholder="Input Tanggal">
                            </div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Total Pembelian</label>
                            <div class="col-sm-10"><input type="text" class="form-control total_buy" name="total_buy" disabled></div>
                        </div>
                                    ...
                                    <div class="form-row" id="first_typeahead">
                                        ...
                                        <div class="form-group col-3 col-sm-2">
                                            <div class="input-group">
                                                <input type="text" name="hpp[]" class="form-control m-input hpp text-right" autocomplete="off" disabled>
                            ...
                            <div class="row fileupload-buttonbar">
                                <div class="col-lg-2">
                                    <span class="btn btn-success fileinput-button">
                                        <span><svg class="mr-2" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">

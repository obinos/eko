            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form method="post" id="form">
                        <input type="hidden" name="id_po" id="id_po" value="<?= $po[0]['_id'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control date" name="inputdate" value="<?= datephp('Y-m-d', $po[0]['transaction_date']) ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Total Pembelian</label>
                            <div class="col-sm-10"><input type="text" class="form-control total_buy" name="total_buy" readonly value="<?= thousand($po[0]['total']) ?>"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-row d-flex align-items-end">
                                    ...
                                    <div class="form-group mb-1 col-3 col-sm-5">
                                    ...
                                    <div class="form-group mb-1 col-3 col-sm-1">
                                ...
                                <?php foreach ($item as $i) { ?>
                                    <div id="inputFormRow">
                                        <div class="form-row" id="<?= $i['id_item'] ?>">
                                            ...
                                            <div class="form-group col-1">
                                                <input type="text" name="price_pack[]" class="form-control m-input text-right price_pack" autocomplete="off" data-id="<?= $i['id_item'] ?>" value="<?= $i['price'] ? thousand($i['price']) : thousand($i['hpp']) ?>">
                                            </div>
                                            <div class="form-group col-1">
                                                <input type="text" name="total_price[]" class="form-control m-input text-right total_price" autocomplete="off" data-id="<?= $i['id_item'] ?>" value="<?= $i['total_price'] ? thousand($i['total_price']) : thousand($i['qty'] * $i['hpp']) ?>">
                                            </div>
                                            <div class="form-group col-3 col-sm-1">
                                                <div class="input-group">
                                                    <input type="text" name="hpp[]" class="form-control m-input text-right hpp" autocomplete="off" data-id="<?= $i['id_item'] ?>" disabled value="<?= $i['hpp'] ? thousand($i['hpp']) : null ?>">
